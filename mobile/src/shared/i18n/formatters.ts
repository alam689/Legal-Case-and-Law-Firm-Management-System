/**
 * ⚠ এই file `web/src/shared/i18n/formatters.ts`-এর প্রতিচ্ছবি।
 *
 * তারিখ/টাকা/সংখ্যার নিয়ম দুই app-এ **অবিকল** এক থাকতেই হবে — মক্কেল
 * ফোনে যে তারিখ দেখেন আর আইনজীবী ওয়েবে যে তারিখ দেখেন, দুটো আলাদা হলে
 * এই product-এর মূল দাবিটাই মিথ্যা হয়ে যায়।
 *
 * `packages/*`-এ সরানো হয়নি কারণ §16-এর shared layer-এ তিনটি package-ই
 * ঘোষিত; formatter সরাতে হলে web-এর সব import বদলাতে হবে। সেটি আলাদা
 * কাজ — ততদিন দুটো file হাতে মিলিয়ে রাখতে হবে।
 */
